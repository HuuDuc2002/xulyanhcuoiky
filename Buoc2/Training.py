...
def load_metadata(path):
    ...
    print("runned arr[140].image_path()")
    print(arr)
    print(arr[88].image_path())
...
# metadata = load_metadata('../image/Vladimir_Putin')
# metadata = load_metadata('D:/XuLyAnh/NhanDangKhuonMat/image/Vladimir_Putin/')
...
# filename_test = '../test/BanNinh_0060.bmp'
...
mydict = ['BanAn','BanBang','BanChi','BanDang','BanDat','BanDuy','BanHai','BanHoa','BanHoang','BanLuan','BanNghiem','BanNguyet','BanNinh','BanPhat','BanPhi','BanPhuong','BanTai','BanTam','BanThanh','BanTien','BanTin','ThayDuc']
